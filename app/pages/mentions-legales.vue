      ...
      <div class="pt-24 lg:pt-32 pb-16">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div class="mt-12 max-w-3xl mx-auto">
            ...
            <h2 class="text-2xl font-bold mt-10 mb-4 text-slate-900">
              Edition du site
            </h2>
            <p class="text-slate-600 mb-4">
              Le présent site, accessible à l’URL
              <span class="text-amber-500 font-bold">
                https://pizza-planet-six.vercel.app/
              </span>
              (le « Site »), est édité par :
            </p>

            <p class="text-slate-600 mb-4 pl-4 border-l-2 border-amber-500">
            ...
            <h2 class="text-2xl font-bold text-slate-900 mt-10 mb-4">
              Hébergement
            </h2>
            <p class="text-slate-600 mb-4">
            ...
            <ul class="list-none space-y-2 text-slate-600">
              <li>
                <strong class="text-amber-500">Par téléphone :</strong>
                +33767265366
              </li>
              <li>
                <strong class="text-amber-500">Par email :</strong>
                contact@lafabriqueducode.fr
              </li>
              <li>
                <strong class="text-amber-500">Par courrier :</strong> 27A
